...
Elm.Issues.About.make = function (_elm) {
   ...
   var viewLiteIs = function () {
      var styles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding-top",_1: "20px"},{ctor: "_Tuple2",_0: "font-size",_1: "26px"}]));
      return A2($Html.span,_U.list([styles,$Html$Attributes.$class("lite-italic")]),_U.list([$Html.text("IS")]));
   }();
   var viewHeader = function () {
      var styles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding-top",_1: "96px"}]));
