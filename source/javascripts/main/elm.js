...
Elm.Model.make = function (_elm) {
   ...
   var midScreen = function (model) {    var _p2 = model.screen;if (_p2.ctor === "Medium") {    return true;} else {    return false;}};
   var TooSmall = {ctor: "TooSmall"};
...
Elm.Mobile.View.make = function (_elm) {
   ...
   _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("red-logo")]),_U.list([]))
           ...
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("mobile-explanatory-text")]),
           _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text("This screen is hella small")]))
                   ,A2($Html.p,
                   _U.list([]),
                   _U.list([$Html.text("We\'re currently working hard on a version of our site that works well on screens like this one. ")]))
                   ,A2($Html.p,_U.list([]),_U.list([$Html.text("Until then, check us out on your computer (or make your browser bigger).")]))]))]));
...
Elm.View.make = function (_elm) {
   ...
   var viewAboutMenuItem = F2(function (address,model) {
      ...
      _U.list([A2($Html.a,A2(logoAttributes,"facebook","https://www.facebook.com/otherwheres"),_U.list([]))
              ...
              ,A2($Html.a,A2(logoAttributes,"instagram","https://www.instagram.com/otherwheres_magazine/"),_U.list([]))]));
      var hovered = function () {    var _p5 = issueState;if (_p5.ctor === "Hovered") {    return true;} else {    return false;}}();
      var logoTextClasses = $Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "logo-text",_1: true}
                                                               ,{ctor: "_Tuple2",_0: "mid-screen",_1: $Model.midScreen(model)}
                                                               ,{ctor: "_Tuple2",_0: "hovered",_1: hovered}]));
      var logoClass = hovered ? $Html$Attributes.$class("grey-logo") : $Html$Attributes.$class("red-logo");
      ...
      _U.list([A2($Html.div,
      _U.list([innerStyle]),
      _U.list([A2($Html.div,_U.list([logoClass]),_U.list([logos]))
   ...
   var actionButton = function (issue) {
      var isDisaster = function () {    var _p8 = issue.issueType;if (_p8.ctor === "Disaster") {    return true;} else {    return false;}}();
