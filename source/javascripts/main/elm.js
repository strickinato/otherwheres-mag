...
Elm.Update.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "Tick": var _p2 = _p0._0;
         ...
         case "HoverIssue": var _p4 = _p0._0;
           var _p3 = A2($Debug.log,"click",_p4);
           return A2($Util._op["=>"],_U.update(model,{hoveredIssueId: _p4}),$Effects.none);
...
Elm.View.make = function (_elm) {
   ...
   var _op = {};
   var viewSymbol = function (symbol) {
      var styles = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "float",_1: "right"},{ctor: "_Tuple2",_0: "position",_1: "relative"}]));
      return A2($Html.span,_U.list([styles,$Html$Attributes.$class("numeral")]),_U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text(symbol)]))]));
   };
   ...
   var viewIssueMenuItem = F3(function (address,model,issue) {
      var classes = $Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "issue",_1: true}
                                                       ...
                                                       ,{ctor: "_Tuple2",_0: "selected-issue",_1: A2(isSelectedIssue,issue.id,model.expandedIssueId)}]));
      ...
      var showTitle = A2(F2(function (x,y) {    return x || y;}),$Basics.not($Model.isShowingMenu(model)),A2(isSelectedIssue,issue.id,model.hoveredIssueId));
      var issueDisplay = showTitle ? issue.title : issue.symbol;
      ...
      return A2($Html.section,_U.list([classes,styles,expandHandler,hoverHandler]),_U.list([A2($Html.h3,_U.list([]),_U.list([$Html.text(issueDisplay)]))]));
   });
