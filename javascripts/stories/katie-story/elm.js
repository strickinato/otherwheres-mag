...
Elm.Html = Elm.Html || {};
Elm.Html.Decoder = Elm.Html.Decoder || {};
Elm.Html.Decoder.make = function (_elm) {
   "use strict";
   _elm.Html = _elm.Html || {};
   _elm.Html.Decoder = _elm.Html.Decoder || {};
   if (_elm.Html.Decoder.values) return _elm.Html.Decoder.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var DeviceRotationRate = F3(function (a,b,c) {    return {alpha: a,beta: b,gamma: c};});
   var DeviceAcceleration = F3(function (a,b,c) {    return {x: a,y: b,z: c};});
   var DeviceOrientationEvent = F4(function (a,b,c,d) {    return {alpha: a,beta: b,gamma: c,absolute: d};});
   var DeviceMotionEvent = F4(function (a,b,c,d) {    return {acceleration: a,accelerationIncludingGravity: b,rotationRate: c,interval: d};});
   var AnimationEvent = F3(function (a,b,c) {    return {animationName: a,elapsedTime: b,pseudoElement: c};});
   var GamepadEvent = function (a) {    return {gamepad: a};};
   var GamepadButton = F2(function (a,b) {    return {pressed: a,value: b};});
   var Gamepad = F7(function (a,b,c,d,e,f,g) {    return {id: a,index: b,connected: c,timestamp: d,mapping: e,axes: f,buttons: g};});
   var CompositionEvent = function (a) {    return {data: a};};
   var compositionEvent = A2($Json$Decode.map,CompositionEvent,A2($Json$Decode._op[":="],"data",$Json$Decode.string));
   var dom_key_location_numpad = 3;
   var dom_key_location_right = 2;
   var dom_key_location_left = 1;
   var dom_key_location_standard = 0;
   var KeyboardEvent = F9(function (a,b,c,d,e,f,g,h,i) {
      return {key: a,code: b,location: c,ctrlKey: d,shiftKey: e,altKey: f,metaKey: g,repeat: h,isComposing: i};
   });
   var dom_delta_page = 2;
   var dom_delta_line = 1;
   var dom_delta_pixel = 0;
   var WheelEvent = function (a) {
      return function (b) {
         return function (c) {
            return function (d) {
               return function (e) {
   ...
   var MouseEvent = F9(function (a,b,c,d,e,f,g,h,i) {
      return {screenX: a,screenY: b,clientX: c,clientY: d,ctrlKey: e,shiftKey: f,altKey: g,metaKey: h,button: i};
   });
   var andMap = $Json$Decode.object2(F2(function (x,y) {    return x(y);}));
   var mouseEvent = A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,A2($Json$Decode.map,MouseEvent,A2($Json$Decode._op[":="],"screenX",$Json$Decode.$int)),A2($Json$Decode._op[":="],"screenY",$Json$Decode.$int)),
   ...
   A2($Json$Decode._op[":="],"metaKey",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"button",$Json$Decode.$int));
   var wheelEvent = A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   ...
   A2(andMap,
   A2(andMap,
   A2(andMap,A2($Json$Decode.map,WheelEvent,A2($Json$Decode._op[":="],"screenX",$Json$Decode.$int)),A2($Json$Decode._op[":="],"screenY",$Json$Decode.$int)),
   A2($Json$Decode._op[":="],"clientX",$Json$Decode.$int)),
   A2($Json$Decode._op[":="],"clientY",$Json$Decode.$int)),
   A2($Json$Decode._op[":="],"ctrlKey",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"shiftKey",$Json$Decode.bool)),
   ...
   A2($Json$Decode._op[":="],"deltaZ",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"deltaMode",$Json$Decode.$int));
   var keyboardEvent = A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,A2($Json$Decode.map,KeyboardEvent,A2($Json$Decode._op[":="],"key",$Json$Decode.string)),A2($Json$Decode._op[":="],"code",$Json$Decode.string)),
   A2($Json$Decode._op[":="],"location",$Json$Decode.$int)),
   A2($Json$Decode._op[":="],"ctrlKey",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"shiftKey",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"altKey",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"metaKey",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"repeat",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"isComposing",$Json$Decode.bool));
   var gamepadButton = A2(andMap,
   A2($Json$Decode.map,GamepadButton,A2($Json$Decode._op[":="],"pressed",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"value",$Json$Decode.$float));
   var gamepad = A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,
   A2(andMap,A2($Json$Decode.map,Gamepad,A2($Json$Decode._op[":="],"id",$Json$Decode.string)),A2($Json$Decode._op[":="],"index",$Json$Decode.$int)),
   A2($Json$Decode._op[":="],"connected",$Json$Decode.bool)),
   A2($Json$Decode._op[":="],"timestamp",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"mapping",$Json$Decode.string)),
   A2($Json$Decode._op[":="],"axes",$Json$Decode.list($Json$Decode.$float))),
   A2($Json$Decode._op[":="],"buttons",$Json$Decode.list(gamepadButton)));
   var gamepadEvent = A2($Json$Decode.map,GamepadEvent,A2($Json$Decode._op[":="],"gamepad",gamepad));
   var animationEvent = A2(andMap,
   A2(andMap,
   A2($Json$Decode.map,AnimationEvent,A2($Json$Decode._op[":="],"animationName",$Json$Decode.string)),
   A2($Json$Decode._op[":="],"elapsedTime",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"pseudoElement",$Json$Decode.string));
   var deviceOrientationEvent = A2(andMap,
   A2(andMap,
   A2(andMap,
   A2($Json$Decode.map,DeviceOrientationEvent,A2($Json$Decode._op[":="],"alpha",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"beta",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"gamma",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"absolute",$Json$Decode.bool));
   var deviceAcceleration = A2(andMap,
   A2(andMap,A2($Json$Decode.map,DeviceAcceleration,A2($Json$Decode._op[":="],"x",$Json$Decode.$float)),A2($Json$Decode._op[":="],"y",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"z",$Json$Decode.$float));
   var deviceRotationRate = A2(andMap,
   A2(andMap,
   A2($Json$Decode.map,DeviceRotationRate,A2($Json$Decode._op[":="],"alpha",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"beta",$Json$Decode.$float)),
   A2($Json$Decode._op[":="],"gamma",$Json$Decode.$float));
   var deviceMotionEvent = A2(andMap,
   A2(andMap,
   A2(andMap,
   A2($Json$Decode.map,DeviceMotionEvent,A2($Json$Decode._op[":="],"acceleration",deviceAcceleration)),
   A2($Json$Decode._op[":="],"accelerationIncludingGravity",deviceAcceleration)),
   A2($Json$Decode._op[":="],"rotationRate",deviceRotationRate)),
   A2($Json$Decode._op[":="],"interval",$Json$Decode.$float));
   return _elm.Html.Decoder.values = {_op: _op
                                     ...
                                     ,dom_key_location_standard: dom_key_location_standard
...
Elm.Model.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var storyScrollTopToBottom = function (model) {    return model.storyHeight - model.boundY + 1000;};
   var scrollPercentage = function (model) {    return $Basics.toFloat(model.scrollLevel) / $Basics.toFloat(storyScrollTopToBottom(model));};
   var womanAssetLocation = "assets/woman.gif";
   var womanScrollSpeed = 0.75;
   var womanSize = 0.75;
   var womanHeight = function (model) {    return $Basics.round(A2(F2(function (x,y) {    return x * y;}),womanSize,$Basics.toFloat(model.storyHeight)));};
   var womanDistanceFromTop = function (model) {
      var maxScroll = womanHeight(model) - model.boundY;
      var womanScroll = $Basics.floor($Basics.toFloat(model.scrollLevel * -1) * womanSize * womanScrollSpeed);
      return _U.cmp(womanScroll * -1,maxScroll) > 0 ? maxScroll * -1 : womanScroll;
   };
   var Small = {ctor: "Small"};
   var Big = {ctor: "Big"};
   var initDrops = _U.list([{x: -12,y: -20,dropType: Small,sequence: 0.1}
                           ...
                           ,{x: -20,y: 49,dropType: Small,sequence: 0.7}
                           ...
                           ,{x: 25,y: 49,dropType: Small,sequence: 0.8}]);
   var Bottom = {ctor: "Bottom"};
   var Top = {ctor: "Top"};
   var Scrolling = {ctor: "Scrolling"};
   var model = {boundX: 0,boundY: 0,storyHeight: 0,scrollLevel: 0,drops: initDrops,scrollStatus: Scrolling,top: 0};
   var Drop = F4(function (a,b,c,d) {    return {x: a,y: b,dropType: c,sequence: d};});
   var Model = F7(function (a,b,c,d,e,f,g) {    return {boundX: a,boundY: b,storyHeight: c,scrollLevel: d,drops: e,scrollStatus: f,top: g};});
   return _elm.Model.values = {_op: _op
                              ...
                              ,initDrops: initDrops
                              ,womanSize: womanSize
                              ,womanScrollSpeed: womanScrollSpeed
                              ,womanAssetLocation: womanAssetLocation
                              ,womanHeight: womanHeight
                              ,womanDistanceFromTop: womanDistanceFromTop
                              ,storyScrollTopToBottom: storyScrollTopToBottom
                              ,scrollPercentage: scrollPercentage};
};
Elm.Model = Elm.Model || {};
Elm.Model.StoryText = Elm.Model.StoryText || {};
Elm.Model.StoryText.make = function (_elm) {
   "use strict";
   _elm.Model = _elm.Model || {};
   _elm.Model.StoryText = _elm.Model.StoryText || {};
   if (_elm.Model.StoryText.values) return _elm.Model.StoryText.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var storyText = function () {
      var renderParagraph = function (paragraph) {    return A2($Html.p,_U.list([]),_U.list([$Html.text(paragraph)]));};
      return A2($Html.div,_U.list([$Html$Attributes.id("story-text")]),A2($List.map,renderParagraph,storyParts));
   }();
   var author = A2($Html.h2,_U.list([$Html$Attributes.id("author")]),_U.list([$Html.text("Katie Wheeler-Dubin")]));
   var byLine = A2($Html.h2,_U.list([$Html$Attributes.id("byline")]),_U.list([$Html.text("by")]));
   var title = A2($Html.h1,_U.list([$Html$Attributes.id("title")]),_U.list([$Html.text("Jason Caroll")]));
   var presents = A2($Html.h2,_U.list([$Html$Attributes.id("presents")]),_U.list([$Html.text("Otherwheres Presents:")]));
   return _elm.Model.StoryText.values = {_op: _op,presents: presents,title: title,byLine: byLine,author: author,storyText: storyText,storyParts: storyParts};
};
...
Elm.Update.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var isPositive = function (num) {    return _U.cmp(num,0.0) > 0 ? true : false;};
   var Addresses = function (a) {    return {storyHeightAddress: a};};
   var NoOp = {ctor: "NoOp"};
   var pingAddress = function (address) {    return A2($Task.map,function (_p0) {    return NoOp;},A2($Signal.send,address,{ctor: "_Tuple0"}));};
   var update = F3(function (addresses,action,model) {
      var _p1 = action;
      switch (_p1.ctor)
      {case "Viewport": return {ctor: "_Tuple2"
                               ,_0: _U.update(model,{boundX: _p1._0._0,boundY: _p1._0._1})
                               ,_1: $Effects.task(pingAddress(addresses.storyHeightAddress))};
         case "Scroll": var scrollUpdate = model.scrollLevel + $Basics.floor(_p1._0);
           var _p2 = _U.cmp(scrollUpdate,0) < 1 ? {ctor: "_Tuple2",_0: 0,_1: $Model.Top} : _U.cmp(scrollUpdate,
           $Model.storyScrollTopToBottom(model)) > 0 ? {ctor: "_Tuple2",_0: $Model.storyScrollTopToBottom(model),_1: $Model.Bottom} : {ctor: "_Tuple2"
                                                                                                                                      ,_0: scrollUpdate
                                                                                                                                      ,_1: $Model.Scrolling};
           var newScrollLevel = _p2._0;
           var newScrollStatus = _p2._1;
           var newModel = _U.update(model,{scrollLevel: newScrollLevel,scrollStatus: newScrollStatus});
           return {ctor: "_Tuple2",_0: newModel,_1: $Effects.none};
         case "SetStoryHeight": return {ctor: "_Tuple2",_0: _U.update(model,{storyHeight: _p1._0}),_1: $Effects.none};
         case "SetTop": return {ctor: "_Tuple2",_0: _U.update(model,{top: _p1._0}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var SetTop = function (a) {    return {ctor: "SetTop",_0: a};};
   var Scroll = function (a) {    return {ctor: "Scroll",_0: a};};
   var SetStoryHeight = function (a) {    return {ctor: "SetStoryHeight",_0: a};};
...
Elm.Util.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toPixel = function (num) {    return A2($Basics._op["++"],$Basics.toString(num),"px");};
   return _elm.Util.values = {_op: _op,toPixel: toPixel};
};
Elm.View = Elm.View || {};
Elm.View.make = function (_elm) {
   ...
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Decoder = Elm.Html.Decoder.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Model = Elm.Model.make(_elm),
   $Model$StoryText = Elm.Model.StoryText.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Svg = Elm.Svg.make(_elm),
   ...
   var _op = {};
   var scrollCaptureHandler = F2(function (address,model) {
      var isPreventDefault = function () {
         var _p0 = model.scrollStatus;
         switch (_p0.ctor)
         {case "Scrolling": return true;
            case "Bottom": return false;
            default: return false;}
      }();
      var options = {stopPropagation: false,preventDefault: isPreventDefault};
      return A4($Html$Events.onWithOptions,
      "wheel",
      options,
      $Html$Decoder.wheelEvent,
      function (event) {
         return A2($Signal.message,address,$Update.Scroll(event.deltaY));
      });
   });
   var renderDrop = F3(function (model,_p1,drop) {
      var _p2 = _p1;
      var url = function () {
         var _p3 = drop.dropType;
         if (_p3.ctor === "Big") {
               return "assets/pearl-big.png";
            } else {
               return "assets/pearl-little.png";
            }
      }();
      var fadeSpeed = 12;
      var startNudge = -0.1;
      var fadeInValue = ($Model.scrollPercentage(model) - drop.sequence + startNudge) * fadeSpeed;
      var yOffset = drop.y * $Model.womanHeight(model) / 100 | 0;
      var yCoord = _p2._1 + yOffset;
      var xOffset = drop.x * (model.boundX / 4 | 0) / 100 | 0;
      var xCoord = _p2._0 + xOffset;
      return A2($Svg.image,
      _U.list([$Svg$Attributes.width($Util.toPixel(21))
              ,$Svg$Attributes.height($Util.toPixel(20))
              ,$Svg$Attributes.opacity($Basics.toString(fadeInValue))
              ,$Svg$Attributes.xlinkHref(url)
              ,$Svg$Attributes.x($Util.toPixel(xCoord))
              ,$Svg$Attributes.y($Util.toPixel(yCoord))]),
      _U.list([]));
   });
   var renderDrops = function (model) {
      var halfOfWomanHeight = $Model.womanHeight(model) / 2 | 0;
      var womanYOrigin = $Model.womanDistanceFromTop(model) + halfOfWomanHeight;
      var womanXOrigin = $Basics.floor(A2(F2(function (x,y) {    return x * y;}),0.75,$Basics.toFloat(model.boundX)));
      return A2($List.map,A2(renderDrop,model,{ctor: "_Tuple2",_0: womanXOrigin,_1: womanYOrigin}),model.drops);
   };
   var renderWomanImage = function (model) {
      var nudgeOneQuarter = model.boundX / 4 | 0;
      return A2($Svg.image,
      _U.list([$Svg$Attributes.width($Util.toPixel(model.boundX))
              ,$Svg$Attributes.height($Util.toPixel($Model.womanHeight(model)))
              ,$Svg$Attributes.xlinkHref($Model.womanAssetLocation)
              ,$Svg$Attributes.x($Util.toPixel(nudgeOneQuarter))
              ,$Svg$Attributes.y($Util.toPixel($Model.womanDistanceFromTop(model)))
              ,$Svg$Attributes.overflow("hidden")]),
      _U.list([]));
   };
   var renderWomanSection = function (model) {
      var womanSections = A2($List._op["::"],renderWomanImage(model),renderDrops(model));
      var womanSectionStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "height",_1: $Util.toPixel(model.storyHeight)}]));
      return A2($Html.div,
      _U.list([$Svg$Attributes.id("katie-story-woman-section"),womanSectionStyle]),
      _U.list([A2($Svg.svg,
      _U.list([$Svg$Attributes.width($Util.toPixel(model.boundX)),$Svg$Attributes.height($Util.toPixel(model.storyHeight)),$Svg$Attributes.overflow("hidden")]),
      womanSections)]));
   };
   var renderStorySection = function (model) {
      var topValueBasedOnScroll = $Util.toPixel(model.scrollLevel * -1);
      var storySectionStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "top",_1: topValueBasedOnScroll}]));
      return A2($Html.div,
      _U.list([$Svg$Attributes.id("katie-story-story-section"),storySectionStyle]),
      _U.list([$Model$StoryText.presents,$Model$StoryText.title,$Model$StoryText.byLine,$Model$StoryText.author,$Model$StoryText.storyText]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Svg$Attributes.id("katie-story-container"),A2(scrollCaptureHandler,address,model)]),
      _U.list([renderWomanSection(model),renderStorySection(model)]));
   });
   return _elm.View.values = {_op: _op
                             ,view: view
                             ,renderStorySection: renderStorySection
                             ,renderWomanSection: renderWomanSection
                             ,renderWomanImage: renderWomanImage
                             ,renderDrops: renderDrops
                             ,renderDrop: renderDrop
                             ,scrollCaptureHandler: scrollCaptureHandler};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var requestStoryHeightMailbox = $Signal.mailbox({ctor: "_Tuple0"});
   var requestStoryHeight = Elm.Native.Port.make(_elm).outboundSignal("requestStoryHeight",function (v) {    return [];},requestStoryHeightMailbox.signal);
   var sendStoryHeight = Elm.Native.Port.make(_elm).inboundSignal("sendStoryHeight",
   "Int",
   function (v) {
      return typeof v === "number" && isFinite(v) && Math.floor(v) === v ? v : _U.badPort("an integer",v);
   });
   var app = function () {
      var addresses = {storyHeightAddress: requestStoryHeightMailbox.address};
      var updateStoryHeight = A2($Signal.map,function (num) {    return $Update.SetStoryHeight(num);},sendStoryHeight);
      return $StartApp.start({init: {ctor: "_Tuple2",_0: $Model.model,_1: $Effects.none}
                             ,update: $Update.update(addresses)
                             ,view: $View.view
                             ,inputs: _U.list([viewport,updateStoryHeight])});
   }();
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.Main.values = {_op: _op,app: app,main: main,requestStoryHeightMailbox: requestStoryHeightMailbox,viewport: viewport};
};
